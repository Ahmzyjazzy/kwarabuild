				...
				<div class="row align-items-center">
					<div class="col-sm-6">
						<div class="feature-list-image">
							<img src="~/assets/images/assets/technologies/android.png" class="img-fluid" alt="Official android logo" width="100%"
								height="50%">
						</div>
					</div>
		...
		<section class="section-spacer">
			<div class="container">
				<div class="row flex-column-reverse flex-sm-row align-items-cengit ter">
					...
					<div class="col-sm-6">
						<div class="feature-list-image">
							<img src="~/assets/images/assets/technologies/web.png" alt="Developer building a progressive web app" class="img-fluid" height="60%"
								width="90%">
						</div>
					</div>
				</div>
		...
		<section id="hip" class="section-spacer bg-very__gray">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-sm-6">
						<div class="feature-list-image">
							<img src="~/assets/images/assets/technologies/cloud.png" class="img-fluid" alt="Illustration of data uploading to the cloud" width="90%">
						</div>
					</div>
					<div class="col-sm-5 ml-auto">
						<div class="feature-list-wrapper">
		...
		<section class="section-spacer">
			<div class="container">
				<div class="row flex-column-reverse flex-sm-row align-items-cengit ter">
					...
					<div class="col-sm-6">
						<div class="feature-list-image">
							<img src="~/assets/images/assets/technologies/mi.png" class="img-fluid" alt="Robotic illustration of how many different things it can do" height="60%"
								width="90%">
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-md-4 col-12">
								<div class="card event-card">
									<img class="card-img-top" src="~/assets/images/assets/events/fbw.png" alt="Event one poster">
									<div class="card-body">
							...
							<div class="col-md-4 col-12">
								<div class="card event-card">
									<img class="card-img-top" src="~/assets/images/assets/events/fba.png" alt="Event two poster">
									<div class="card-body">
							...
							<div class="col-md-4 col-12">
								<div class="card event-card">
									<img class="card-img-top" src="~/assets/images/assets/events/rpj.png" alt="Event three poster">
									<div class="card-body">
				...
				<div class="container-fluid">
					...
					<div class="carousel-item col-md-4 col-15 active">
						...
						<div class="card hovercard">
							...
							<div class="avatar">
								<img src="~/assets/images/assets/team/avatar.png" alt="lead avatar">
							</div>
							<div class="info">
								<div class="title">
		...
		<section id="faqs" class="section-spacer section-faq">
			<div class="container">
							...
							<div class="card-body">
								...
								<p>We have a hands-on session every Tuesday at SG25 from 1800hrs to 2030hrs. We also hold
									workshops and showcases & we would recommend you to join our community on <a
											href="https://www.meetup.com/DSCUniversity/">Meetup</a> to get updates.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="mt-40 text-center">
					<a href="mailto:dscuniversity.com" class="hero-button">Send us an email</a>
				</div>
			</div>
		</section>
	</div>
