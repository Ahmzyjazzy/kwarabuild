				...
				<div class="col-md-4 col-12">
					<div class="feature-card">
						<div class="feature-card__body">
							...
							<h4 class="feature-title">About Kwarabuild</h4>
							<p>The Kwarabuild program is a grassroots channel through which Google provides development skills, mobile and web development skills towards employability.
							</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4 col-12">
					<div class="feature-card m-0">
						<div class="feature-card__body">
							...
							<h4 class="feature-title">Our Value</h4>
							<p>Kwarabuild activities are targeted at University students and any others
